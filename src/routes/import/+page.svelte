<script lang="ts">
  ...
  async function handleUrlImport() {
    ...
    fetch("http://127.0.0.1:7242/ingest/a90338e3-4e71-4021-9d29-b1dca4cf7605", {
      ...
      body: JSON.stringify({
        location: "import/+page.svelte:13",
        message: "handleUrlImport called",
    ...
    try {
      ...
      if (
        ...
        error =
          "Recipe imported but appears incomplete (no ingredients found). This may be due to a paywall. Try using the 'Paste JSON' method for complete recipes.";
        loading = false;
        return;
      }
      ...
      fetch(
        "http://127.0.0.1:7242/ingest/a90338e3-4e71-4021-9d29-b1dca4cf7605",
        {
          ...
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            location: "import/+page.svelte:41",
...
<div class="import-page">
  <header>
    ...
    <h1>Import Recipe</h1>
    <p class="subtitle">
      Add a recipe from a URL, file, or paste JSON directly
    </p>
  </header>
  ...
  <div class="import-form card">
    ...
    {:else if importMethod === "file"}
      <div class="form-group">
        ...
        <p class="hint">Upload a Soustack JSON file or any JSON recipe file.</p>
      </div>
